...
while endGame != "quit":
    ...
    if (r.status_code != 200):
        ...
        if user_answer == correct_answer:
            print("\nCongratulations! You answered correct! The correct answer was: " + html.unescape(correct_answer))
            score_correct += 1
        else:
            print("Sorry, " + html.unescape(user_answer) + " is incorrect. The right answer is "
